...
export default class NewMessage extends Component {
	...
	componentDidMount(){
		...
		let that=this;
		that.props.psocket.on('setReminder', function(entities){
			//console.log("confirmSetRemainderResult: ", result);
			that.setState({reminderDialog: true, entities: entities});
		});
    ...
    handleSubmitReminder(){
		this.setState({reminderDialog: false});
		this.props.psocket.emit('reminderAccepted', this.props.name, this.state.summary, this.state.location, this.state.startDate, this.state.endDate);
	}
	...
	render() {
		...
		else if (this.state.reminderDialog) {
			return (
					<div>
						<Dialog
