...
export default class ChatMessage extends Component{
  ...
  render(){
    ...
    const reminderLink = (this.props.message.reminder.status)?(<CardActions actAsExpander={true}><a href="#">Set reminder in your calender</a></CardActions>):(console.log());
    const intent = (this.props.intentVal != '')?(<CardMedia expandable={true}><GenericForm reminder = {this.props.message.reminder} intentVal={this.props.intentVal} intent_metadata={this.props.intent_metadata} intentdata={this.props.intentdata}/></CardMedia>):(console.log())  
