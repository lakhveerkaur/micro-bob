...
export default class Bob extends React.Component{
  ...
  componentDidMount(){
    ...
    // this.context.socket.on('newProjectStatus',function(members,channel){
    //   var project = channel.split('#')[0];
    //   console.log(that.state.projectStatus,"while creating projectStatus");
    //   console.log(members,project,"------------new project members---------");
    //   var arr1=[];
    //  // var arr1 = that.state.projectStatus;
    //   var obj = {
    //     projectName:project,
    //     users:members
    //   }
    ...
    //   arr1.push(obj);
    //   that.setState({projectStatus:arr1});
    //   console.log(that.state.projectStatus,"projectStatus after");
    // })
    this.context.socket.on('getStatus',function(getstatus){
    console.log(getstatus,"user fetching status while login");
    //var status = getstatus;
    
    
    console.log(that.state.projectStatus,"while login projectStatus");
    ...
    this.context.socket.on('userStatus',(message,channel)=>{
      ...
      console.log(that.state.projectStatus,"while publishing projectstate");
      ...
      if(channel === item.projectName){
       ...
       // console.log(item.users,"users after");
        ...
        updated.push(obj);  
         ...
         console.log("in end of publishing",that.state.projectStatus);
