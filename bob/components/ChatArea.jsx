...
export default class Chat extends React.Component{
	...
	{
		super(props);
		this.state={typing:[],authOpen:false,chatHistory:[],pagesDisplayed:0,
	...
	handleSelect(book,event,status){
		console.log("bookmark",book,"event",event,"status",status)
		if(status){
 	...
 	render(){
        ...
        const outlookAuthURL='https://login.microsoftonline.com/common/oauth2/v2.0/authorize?redirect_uri=http%3A%2F%2Flocalhost%3A8082%2Fauthorize&scope=openid%20https%3A%2F%2Foutlook.office.com%2Fmail.read&response_type=code&client_id=5c83ada4-1314-4f4d-bf26-4bf658577322';
        const googleAuthURL='https://accounts.google.com/o/oauth2/auth?redirect_uri=http://localhost:8000/oauth2callback&response_type=code&client_id=616007233163-g0rk4o8g107upgrmcuji5a8jpnbkd228.apps.googleusercontent.com&scope=https://www.googleapis.com/auth/calendar+https://www.googleapis.com/auth/userinfo.email+https://www.googleapis.com/auth/userinfo.profile&approval_prompt=force&access_type=offline';
